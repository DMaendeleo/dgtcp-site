...
export interface Config {
  ...
  collectionsSelect: {
    ...
    rapports: RapportsSelect<false> | RapportsSelect<true>;
  ...
  globalsSelect: {
    siteHeader: SiteHeaderSelect<false> | SiteHeaderSelect<true>;
  };
  locale: null;
  user: User & {
    collection: 'users';
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "rapports_select".
 */
export interface RapportsSelect<T extends boolean = true> {
  title?: T;
  description?: T;
  year?: T;
  dateUploaded?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "siteHeader_select".
 */

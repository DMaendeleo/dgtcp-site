...
<script lang="ts">
    ...
    export let subtitle: string =
        "Situation des dépenses publiques exécutées\n" +
        "en procédure d'urgence pour la période du\n" +
        "4ème trimestre 2024";
...
<!--    </div>-->
    ...
    <div class="relative h-[72vh] min-h-[520px] md:h-[78vh] lg:h-[86vh] max-h-[700px]">
        <picture>
            <source media="(min-width: 1024px)" srcset="{welcome}" />
            <img
                    src="{welcome_800}"
        ...
        >
            <div class="text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)]">
                ...
                <h1
                 ...
                 text-[clamp(1.5rem,6vw,2.75rem)] sm:text-4.5xl md:text-6xl lg:text-7xl text-[#F2DE00]"
                >
                    {#each title.split('\n') as line, i}
         ...
         max-w-[68ch] lg:text-2xl text-[#C2DBFF]"
                >
                    Situation des dépenses publiques exécutées en procédure d'urgence<br />
                    pour la période du 4ème trimestre 2024
                </p>
                <!-- Pager dots -->
                <div class="mt-6 flex gap-2 justify-center text-center" role="tablist" aria-label="Diapos">
